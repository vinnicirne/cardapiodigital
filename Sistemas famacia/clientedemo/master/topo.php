    ...
    <div class="slim-body">
      <div class="slim-sidebar">
        ...
        <ul class="nav nav-sidebar">
          ...
          <li class="sidebar-nav-item">
            <a href="mesas.php" class="sidebar-nav-link"><i class="fa fa-qrcode mg-r-10" style="font-size:16px"></i> QRCode para Vendedor</a>
          </li>
		   <li class="sidebar-nav-item">
            <a href="bairros.php" class="sidebar-nav-link"><i class="fa fa-car mg-r-10" style="font-size:16px"></i> Entregas e Taxas</a>
          </li>
		   <li class="sidebar-nav-item">
