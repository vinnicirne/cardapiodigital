...
<div class="slim-mainpanel">
	  ...
	  <div class="section-wrapper mg-b-20">
		  ...
		  <input type="hidden" name="idcpes" value="<?php print $->id; ?>">
            ...
            <div class="row mg-b-25">
			  ...
			  <div class="col-lg-5">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nome" value="<?php print $->nomeadmin; ?>">
                </div>
              </div><!-- col-4 -->
			  ...
			  <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="email" value="<?php print $->email; ?>" maxlength="60">
                </div>
              </div><!-- col-4 -->
			  ...
			  <div class="col-lg-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cpf" value="<?php print $->cpf; ?>" maxlength="14">
                </div>
              </div><!-- col-4 -->
