...
<div class="row">
	...
	<div class="col-12 mg-t-10">
		...
		<?php if($cpro->ingredientes != 'N'){?>
		<div class="tx-15" align="justify"><strong>Ingredientes: </strong><?=$cpro->ingredientes;?></div>
		<?php } ?>
	 
		<?php if($cpro->valor > "0.00") { ?>
		<div class="tx-18 tx-info mg-t-5"><strong>R$: </strong><?=number_format($cpro->valor, 2, ',', '.');?></div>
		<?php } ?>
	
 	</div>
</div>

<form action="ajax/produtoi2.php" method="post">
	...
	<input type="hidden" name="idsecao" value="<?php print $id_cliente; ?>">
	...
	<div class="row mg-t-10">
		...
		<div class="col-6">
			<button id="btn-incluir-pedido" type="submit" class="btn btn-primary btn-block"><i class="fa fa-plus-square"></i> Incluir</button>
		</div>
	</form>
