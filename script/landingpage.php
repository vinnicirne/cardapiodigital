...
<!--[if lte IE 8]>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col--md-4 col-sm-4 col-xs-4">
          <a href="<?=$site;?>" id="logo">
            <img src="<?= $site; ?>img/home.png" alt="Página Inicial" height="30" width="30" alt="" data-retina="true" class="hidden-xs">
            <img src="<?= $site; ?>img/home.png" alt="Página Inicial" height="30" width="30" alt="" data-retina="true" class="hidden-lg hidden-md hidden-sm">
          </a>
        </div>
        <nav class="col--md-8 col-sm-8 col-xs-8">
          ...
          <div class="main-menu">
            <div id="header_menu">
              ...
              <center><b style="color:#ffffff;">MENU</b></center>
            </div>
            <a href="#" class="open_close" id="close_in"><i class="icon_close"></i></a>
            <ul>
              <li><a href="<?=$site;?>Demo">Demonstração</a></li>
              <li><a href="<?=$site;?>cadastro">Cadastrar</a></li>
  ...
  <section class="parallax-window" id="home" data-parallax="scroll" data-image-src="img/sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
   ...
   <div id="subheader">
      ...
      <div id="sub_content">
        <img src="/img/logo.png" alt="MultDelivery" style="width:25%;margin-top:-13%;">
        <h2 style="color: #fff; font-size: 25px !important">Encontre aqui: <strong id="js-rotating"><b></b>Farmácias & Drogarias</b></strong> !</h2>
        <p>
          As melhores lojas estão aqui. Descubra!
        </p>
        <form method="post" id="formsearch">
          <div id="custom-search-input">
            <div class="input-group ">
              <input type="tel" class="search-query cep" id="valor_cep" placeholder="Digite seu CEP">
              <b><a style="color: #ffffff;margin-top: 5px;" href="https://buscacepinter.correios.com.br/app/endereco/" target="_blank">
                Consultar CEP
              </a>
            </b>            
    ...
    $(document).ready(function(){
      $('#pesquisar').click(function(){
        ...
        if(pesquisa == ''){
          ...
          $.ajax({
            url: '<?=$site?>controlers/processabuscacep.php',
            method: 'post',
            ...
            success: function(data){
              ...
              if(data == 1){
                x0p('Opss... 😕', 
                  'CEP não encontrado, verifique novamente.',
                  'error', false);
              }else if(data == 2){
               x0p('Que pena! 😔', 
  ...
  ?>
  <ul>
   <li><span class="number"><?=$totalCliente;?></span> Lojas</li>
   <li><span class="number"><?=$totalItens;?></span> Produtos cadastrados</li>
  ...
  <div class="white_bg">
    <div class="container margin_60">
      ...
      <div class="main_title">
        <h2 class="nomargin_top">Estabelecimentos mais populares</h2>
        <p>
...
if(!$lerbanco->getResult()):
  ...
  <div class="white_bg">
    <div class="container margin_60">
      ...
      <div class="main_title">
        <h2 class="nomargin_top">Novos Cadastros</h2>
        <p>
...
<div class="row">
  <div class="col-md-3">
    <div class="box_home" id="one">
      ...
      <p>
        Encontre todas as lojas disponíveis em sua região.
      </p>
    </div>
  </div>
  <div class="col-md-3">
    <div class="box_home" id="two">
      ...
      <p>temos as melhores lojas disponíveis aqui.
      </p>
    </div>
  </div>
  <div class="col-md-3">
    <div class="box_home" id="three">
      ...
      <p>
        Informe como vai pagar e insira suas observações!
      </p>
    </div>
  </div>
  <div class="col-md-3">
    <div class="box_home" id="four">
      ...
      <p>
        Envie seu pedido para loja via whatsapp
      </p>
    </div>
  </div>
</div><!-- End row -->        
...
<div class="high_light">
  <div class="container">
    <h3>Quer um espaço <strong>aqui</strong> ?</h3>
    <p>Crie agora seu catálogo online e comece a divulgar hoje mesmo.</p>
    <a href="<?=$site;?>cadastro" target="_blank">CADASTRAR</a>
  </div><!-- End container -->
</div><!-- End hight_light -->
              ...
              <div class='home-chat'>
                ...
                <a class='informasi' href='javascript:void' title='Chat Whatsapp'>
                  ...
                  <div class='info-chat'>
                    ...
                    <span class='chat-nama'>Atendimento aos Cliente</span>
                ...
                <a class='informasi' href='javascript:void' title='Chat Whatsapp'>
                  ...
                  <div class='info-chat'>
                    <span class='chat-label'>Suporte para Vendas</span>
                ...
                <a class='informasi' href='javascript:void' title='Chat Whatsapp'>
                  <div class='info-avatar'><img src='<?=$site?>img/supportfemale.png'/></div>
                  <div class='info-chat'>
                    <span class='chat-label'>Suporte para os nossos clientes</span>
                    <span class='chat-nama'>Atendimento ao Cliente</span>
                  </div><span class='my-number'><?=$texto['telefoneAdministracaoVendas'];?></span>
                ...
                <div class='start-chat hide'>
                  ...
                  <a class='blantershow-chat' href='javascript:void' title='Show Chat'><i class='fab fa-whatsapp'></i>Precisa de ajuda fale conosco?</a>
                </body>
                </html>