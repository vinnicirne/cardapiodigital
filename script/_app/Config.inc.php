...
define('USER', 'USUARIOCPANEL_USUARIOBANCO');
define('PASS', 'SENHA');
define('DBSA', 'USUARIOCPANEL_BANCO');

define("EMAIL_MSG","email@domnio.com.br"); //Email para recebimento e envio de mensagens
define("PHONE_NUMBER","11999988888"); //Telefone para chamarem no whats
...
define('HOME', 'https://seudominio.com.br/');  // SEMPRE COM A BARRA NO FINAL ---- ---- ---- ----
