          ...
          if($view == 0):
            ...
            <tr  <?=($view == 0 ? "style='background-color: #34AF23;font-weight: bold;color:#ffffff'" : "");?>>
             ...
             <td>
              ...
              <td>
                  <button onclick="window.open('https://api.whatsapp.com/send?phone=55<?=$telefone;?>&text=Olá, vimos que recebeu o seu pedido, poderia nos dar um feedback Avaliando nosso Atendimento 0 a 10 e nosso Produto de 0 a 10 e conte como foi sua entrega do seu produto.  ?','_blank');" class="btn btn-warning btn-xs">Pesquisa</button>
              </td>
              <td>
